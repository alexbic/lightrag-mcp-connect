...
После изменения документа LightRAG автоматически перестраивает граф знаний.
Графовые команды нужны только для прямой работы с сущностями и связями.
...
- просмотр графа и управление сущностями и связями
